...
// Add more here...
let showering = 7
let puttingOnUniform = 3
let tyingHijab = 5
let usingPhone = 15
let puttingOnShoes = 1
let leavingHouse = 3
let eatBreakfast = 10
let wakeSiblingsUp = 9
let takeMySisterToSchoolFirst = 7
...
brushTeeth + showering + puttingOnUniform + tyingHijab + usingPhone + puttingOnShoes + leavingHouse + eatBreakfast + wakeSiblingsUp + takeMySisterToSchoolFirst
...
//Things I Have To Do
brushTeeth + puttingOnUniform + tyingHijab + puttingOnShoes + leavingHouse

//Things I Want To Do
showering + usingPhone

//Things I Don't Like To DO
eatBreakfast + wakeSiblingsUp + takeMySisterToSchoolFirst
...
*/
brushTeeth + puttingOnUniform + tyingHijab + usingPhone + puttingOnShoes + leavingHouse
